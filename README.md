graphalgo is a JavaScript library for creating and modifying directed and undirected graphs. In addition to a core graph API, it also comes with implementations for many common graph algorithms.
...
* [[API Reference]]
* [Bug Tracking](/dagrejs/graphalgo/issues)
* [[Contributing]]
* [License](#license)

## Example

This following code block shows a small example of how to use graphalgo in node.js:

```js
var Graph = require("graphalgo").Graph;
...
or graphalgo can be included in a webpage:

```html
<script src="http://PATH/TO/graphalgo.min.js"></script>
 <script>
var g = new graphalgo.Graph();
// ...etc.
```
...
This will generate `graphalgo.js` and `graphalgo.min.js` in the `dist` directory
of the project.

# License

graphalgo is licensed under the terms of the MIT License. See the [LICENSE](LICENSE) file for details.
